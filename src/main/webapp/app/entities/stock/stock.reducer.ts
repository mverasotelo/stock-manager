...
export const getEntities = createAsyncThunk('stock/fetch_entity_list', async ({ page, size, sort, criteria }: any) => {
...
return axios.get<IStock[]>(apiUrl, {params: { criteria, page, size, sort }});
