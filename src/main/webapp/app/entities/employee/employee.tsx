  ...
  return (
    <div>
      <h2 id="employee-heading" data-cy="EmployeeHeading">
        <Translate contentKey="stockmanagerApp.employee.home.title">Employees</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="stockmanagerApp.employee.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/employee/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="stockmanagerApp.employee.home.createLabel">Create new Employee</Translate>
          </Link>
        </div>
      </h2>
        ...
        {employeeList && employeeList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="stockmanagerApp.employee.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="stockmanagerApp.employee.codigo">Codigo</Translate>
                </th>
                <th>
                  <Translate contentKey="stockmanagerApp.employee.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="stockmanagerApp.employee.home.notFound">No Employees found</Translate>
            </div>
          )
        )}
      </div>
