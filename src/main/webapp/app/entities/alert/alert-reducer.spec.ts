...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './alert.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_ALERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALERT actions', async () => {
      const expectedActions = [
        {
