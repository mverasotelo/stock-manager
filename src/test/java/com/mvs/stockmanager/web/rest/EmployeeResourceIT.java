...
import com.mvs.stockmanager.repository.EmployeeRepository;
import com.mvs.stockmanager.service.dto.EmployeeDTO;
import com.mvs.stockmanager.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().codigo(DEFAULT_CODIGO).name(DEFAULT_NAME);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().codigo(UPDATED_CODIGO).name(UPDATED_NAME);
        return employee;
    }
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getCodigo()).isEqualTo(DEFAULT_CODIGO);
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.codigo(UPDATED_CODIGO).name(UPDATED_NAME);
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getCodigo()).isEqualTo(UPDATED_CODIGO);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.codigo(UPDATED_CODIGO).name(UPDATED_NAME);
